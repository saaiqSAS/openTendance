    ...
    private void startServer() {
        if (!interrupted) {
            try {
                ...
                if (e.toString().equals("java.net.SocketException: Connection reset") || e.toString().equals("java.io.EOFException") || e.toString().equals("java.net.SocketException: Socket closed")) {
